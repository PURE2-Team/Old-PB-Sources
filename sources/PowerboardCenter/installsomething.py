...
# INSTALL single or MULTIPLE packages with visual feedback like in SWmanager, no console...
#
...
# How to use:
#
# from Plugins.Extensions.PowerboardCenter.installsomething import InstallSomething
#    ...
#    self.KodiInstallation = InstallSomething(self.session, [xbmc-turbo, my-plugin])
