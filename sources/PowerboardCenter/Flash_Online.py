...
#############################################################################################################
image = 0 
feedurl_pb = 'http://pb-download.com/images/4.0'
	...
	def green(self):
		sel = self["imageList"].l.getCurrentSelection()
    		if getBoxType() == "ixussone" or getBoxType() == "ixusszero":
			    self.setfeed = 'ixuss'
    		elif getBoxType() == "dm7020hd" or getBoxType() == "dm7020hdv2" or getBoxType() == "dm800sev2" or getBoxType() == "dm500hdv2" or getBoxType() == "dm800" or getBoxType() == "dm800se" or getBoxType() == "dm500hd":
			    self.setfeed = 'dmm-original'
    		elif getBoxType() == "vuduo" or getBoxType() == "vuduo2" or getBoxType() == "vusolo" or getBoxType() == "vusolo2" or getBoxType() == "vuuno" or getBoxType() == "vuultimo":
			    self.setfeed = 'vu'
    		elif getBoxType() == "odim7" or getBoxType() == "odinm9":
			    self.setfeed = 'odin'
    		elif getBoxType() == "sf8hd":
			    self.setfeed = 'octagon'
    		elif getBoxType() == "axodin":
			    self.setfeed = 'opticum'				
    		elif getBoxType() == "xp1000":
			    self.setfeed = 'mkdigital'
    		elif getBoxType() == "gb800se" or getBoxType() == "gb800solo" or getBoxType() == "gb800ue" or getBoxType() == "gbquad" or getBoxType() == "gbquadplus" or getBoxType() == "gb800ueplus" or getBoxType() == "gb800seplus":
			    self.setfeed = 'gigablue'
    		elif getBoxType() == "et4x00" or getBoxType() == "et5x00" or getBoxType() == "et6x00" or getBoxType() == "et9x00":
			    self.setfeed = 'xtrend'
    		elif getBoxType() == "mixosf5" or getBoxType() == "mixosf5mini" or getBoxType() == "mixosf7" or getBoxType() == "mixoslumi":
			    self.setfeed = 'mixos'
    		else:
			    self.setfeed = getBoxType()
		if sel == None:
			print"Nothing to select !!"
			return
